...
ADMIN_MENU_ORDER = (
    ...
    ("Site", ("sites.Site", "redirects.Redirect", "conf.Setting", "info.SitewideContent",)),
...
STATIC_ROOT = "/home/cata3017/catalystcms/project/static/"
...
FABRIC = {
     "SSH_USER": "edward", # SSH username for host deploying to
     "HOSTS": ALLOWED_HOSTS[:1], # List of hosts to deploy to (eg, first host)
     "DOMAINS": ALLOWED_HOSTS, # Domains for public site
     "REPO_URL": "https://github.com/EdwardLiang/site-django-mezzanine.git", # Project's repo URL
     "VIRTUALENV_HOME":  "/home/edward", # Absolute remote path for virtualenvs
     "PROJECT_NAME": "catalystcms", # Unique identifier for project
     "REQUIREMENTS_PATH": "requirements.txt", # Project's pip requirements
     "GUNICORN_PORT": 8080, # Port gunicorn will listen on
     "LOCALE": "en_US.UTF-8", # Should end with ".UTF-8"
     "DB_PASS":"Westv!ewC4S",
     "ADMIN_PASS":"Westv!ewC4S",

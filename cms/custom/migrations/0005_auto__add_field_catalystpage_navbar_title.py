...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CatalystPage.navbar_title'
        db.add_column(u'custom_catalystpage', 'navbar_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CatalystPage.navbar_title'
        db.delete_column(u'custom_catalystpage', 'navbar_title')
